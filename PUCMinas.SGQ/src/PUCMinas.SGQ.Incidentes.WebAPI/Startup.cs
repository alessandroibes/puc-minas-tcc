...
using PUCMinas.SGQ.Incidentes.WebAPI.Configuration;

namespace PUCMinas.SGQ.Incidentes.WebAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlServer(Configuration.GetConnectionString("IncidentesConnection"));
            });
